...
> **蓝图对应**：本组件对应 [`BLUEPRINT.md`](../BLUEPRINT.md) 第 5 节「编排域 · 工作流运行时」。
...
```bash
python s16_workflow_runtime/code.py          # 真实 API 运行
python s16_workflow_runtime/code.py demo     # 确定性测试数据
python s16_workflow_runtime/code.py resume   # 断点续跑
```
